...
export const metadata: Metadata = {
  title: 'Baseball App',
  description: 'Learn about baseball and explore the application workflow.',
  openGraph: {
    title: 'Baseball App',
    description: 'Discover the world of baseball and its application workflow.',
    images: [
      {
        url: '/ml.webp',
      },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-4">
                ...
                its players to run the bases, having them advance counter-clockwise around four bases to score what
                are called runs.
              </p>
